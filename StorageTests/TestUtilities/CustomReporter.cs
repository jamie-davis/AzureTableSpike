...
namespace StorageTests.TestUtilities
{
    /// <summary>
    /// Simple utility reporter to choose the quiet reporter on the build server, but the a specific reporter for development work.
    /// </summary>
